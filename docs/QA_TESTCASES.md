...
- [x] **TC-ADB-FORCESTOP-IMPLICIT-RECENTS-BACK-IMPLICIT-02** (AVD) force-stop 후 implicit 진입 뒤 Recents→Back→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `APP_SWITCH` → `BACK` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 2111ms`, `WaitTime: 2139ms`, focus `GraniteActivity`
    - Recents→Back 후 focus: `GraniteActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Warning: intent delivered to currently running top-most instance`, `WaitTime: 15ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Recents→Back 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/am_start_1_implicit.txt`, `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/focus_after_implicit_1.txt`, `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/focus_after_recents_back.txt`, `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/am_start_2_implicit.txt`, `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/focus_after_implicit_2.txt`, `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/after_implicit_2.png`, `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/logcat_tail.txt`, `artifacts/20260219_213744_adb_forcestop_implicit_recents_back_implicit_v2/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-HOME-RECENTS-BACK-EXPLICIT-01** (AVD) force-stop 후 explicit 진입 뒤 Home→Recents→Back→explicit 재진입 — **failed (1차 explicit ANR dialog focus)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `HOME` → `APP_SWITCH` → `BACK` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 28473ms`, `WaitTime: 28494ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - Home→Recents→Back 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 26747ms`, `WaitTime: 26758ms`, focus `GraniteActivity`
    - logcat: `Application Not Responding: viva.republica.toss.test` 관련 항목 검출
  - Verdict: 2차 복구는 되었지만 1차 explicit에서 ANR dialog 포커스로 fail
  - Evidence: `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/pid_after_forcestop.txt`, `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/am_start_1_explicit.txt`, `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/focus_after_explicit_1.txt`, `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/focus_after_home_recents_back.txt`, `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/am_start_2_explicit.txt`, `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/focus_after_explicit_2.txt`, `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/after_explicit_2.png`, `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/logcat_tail.txt`, `artifacts/20260219_213935_adb_forcestop_explicit_home_recents_back_explicit/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-HOME-RECENTS-BACK-EXPLICIT-01** (AVD) force-stop 후 implicit 진입 뒤 Home→Recents→Back→explicit 재진입 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `HOME` → `APP_SWITCH` → `BACK` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 9937ms`, `WaitTime: 9942ms`, focus `GraniteActivity`
    - Home→Recents→Back 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 681ms`, `WaitTime: 691ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Home→Recents→Back 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/pid_after_forcestop.txt`, `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/am_start_1_implicit.txt`, `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/focus_after_implicit.txt`, `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/focus_after_home_recents_back.txt`, `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/am_start_2_explicit.txt`, `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/focus_after_explicit.txt`, `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/after_explicit.png`, `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/logcat_tail.txt`, `artifacts/20260219_214235_adb_forcestop_implicit_home_recents_back_explicit/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-HOME-RECENTS-BACK-IMPLICIT-01** (AVD) force-stop 후 implicit 진입 뒤 Home→Recents→Back→implicit 재진입 — **failed (initial launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `HOME` → `APP_SWITCH` → `BACK` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 12251ms`, focus `NexusLauncherActivity` (초기 진입 실패)
    - Home→Recents→Back 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 7884ms`, `WaitTime: 7887ms`, focus `GraniteActivity` (복구)
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 2차 implicit 복구는 성공했지만 1차 implicit launcher fallback으로 fail
  - Evidence: `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/pid_after_forcestop.txt`, `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/am_start_1_implicit.txt`, `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/focus_after_implicit_1.txt`, `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/focus_after_home_recents_back.txt`, `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/am_start_2_implicit.txt`, `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/focus_after_implicit_2.txt`, `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/after_implicit_2.png`, `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/logcat_tail.txt`, `artifacts/20260219_214444_adb_forcestop_implicit_home_recents_back_implicit/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-HOME-RECENTS-BACK-IMPLICIT-02** (AVD) force-stop 후 explicit 진입 뒤 Home→Recents→Back→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `HOME` → `APP_SWITCH` → `BACK` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 16010ms`, `WaitTime: 16013ms`, focus `GraniteActivity`
    - Home→Recents→Back 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 956ms`, `WaitTime: 979ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Home→Recents→Back 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/am_start_1_explicit.txt`, `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/focus_after_explicit.txt`, `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/focus_after_home_recents_back.txt`, `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/am_start_2_implicit.txt`, `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/focus_after_implicit.txt`, `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/after_implicit.png`, `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/logcat_tail.txt`, `artifacts/20260219_214644_adb_forcestop_explicit_home_recents_back_implicit_v2/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-EXPLICIT-01** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→explicit 재진입 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 2184ms`, `WaitTime: 2221ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 1050ms`, `WaitTime: 1056ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Recents→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/pid_after_forcestop.txt`, `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/am_start_1_implicit.txt`, `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/focus_after_implicit.txt`, `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/focus_after_back_recents_home.txt`, `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/am_start_2_explicit.txt`, `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/focus_after_explicit.txt`, `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/after_explicit.png`, `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/logcat_tail.txt`, `artifacts/20260219_214837_adb_forcestop_implicit_back_recents_home_explicit/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-01** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 — **failed (double launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 16969ms`, focus `NexusLauncherActivity` (초기 진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 13588ms`, focus `NexusLauncherActivity` (재진입 실패)
    - logcat 스캔에서 ANR/FATAL/"ANR likely to follow" 미검출 (obituary 1건)
  - Verdict: 1·2차 implicit 모두 launcher fallback으로 fail
  - Evidence: `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/pid_after_forcestop.txt`, `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/am_start_1_implicit.txt`, `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/focus_after_implicit_1.txt`, `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/focus_after_back_recents_home.txt`, `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/am_start_2_implicit.txt`, `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/focus_after_implicit_2.txt`, `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/after_implicit_2.png`, `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/logcat_tail.txt`, `artifacts/20260219_215037_adb_forcestop_implicit_back_recents_home_implicit/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-01** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 — **failed (1차 explicit ANR dialog + 2차 implicit launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 23485ms`, `WaitTime: 23497ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 12977ms`, focus `NexusLauncherActivity` (재진입 실패)
    - logcat: `Application Not Responding: viva.republica.toss.test` 관련 항목 및 obituary 검출
  - Verdict: 1차 explicit ANR dialog 포커스 + 2차 implicit launcher fallback으로 fail
  - Evidence: `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/pid_after_forcestop.txt`, `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/am_start_1_explicit.txt`, `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/focus_after_explicit.txt`, `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/focus_after_back_recents_home.txt`, `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/am_start_2_implicit.txt`, `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/focus_after_implicit.txt`, `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/after_implicit.png`, `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/logcat_tail.txt`, `artifacts/20260219_215253_adb_forcestop_explicit_back_recents_home_implicit/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-EXPLICIT-02** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **failed (double launcher fallback + app ANR)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 22560ms`, focus `NexusLauncherActivity` (초기 진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: GraniteActivity`, `WaitTime: 13509ms`, focus `NexusLauncherActivity` (재진입 실패)
    - logcat: `ANR in viva.republica.toss.test`, `Completed ANR` 검출
  - Verdict: 1·2차 모두 launcher fallback이며 app ANR 발생으로 fail
  - Evidence: `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/am_start_1_implicit.txt`, `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/focus_after_implicit.txt`, `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/focus_after_back_recents_home.txt`, `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/am_start_2_explicit.txt`, `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/focus_after_explicit.txt`, `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/after_explicit.png`, `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/logcat_tail.txt`, `artifacts/20260219_215530_adb_forcestop_implicit_back_recents_home_explicit_v2/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-EXPLICIT-02** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **failed (initial launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `WaitTime: 19525ms`, focus `NexusLauncherActivity` (초기 진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 14565ms`, `WaitTime: 14569ms`, focus `GraniteActivity` (복구)
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 2차 explicit 복구는 성공했지만 1차 explicit launcher fallback으로 fail
  - Evidence: `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/am_start_1_explicit.txt`, `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/focus_after_explicit_1.txt`, `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/focus_after_back_recents_home.txt`, `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/am_start_2_explicit.txt`, `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/focus_after_explicit_2.txt`, `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/after_explicit_2.png`, `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/logcat_tail.txt`, `artifacts/20260219_215801_adb_forcestop_explicit_back_recents_home_explicit_v2/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-02** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (launcher fallback + focus null)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 11634ms`, focus `NexusLauncherActivity` (초기 진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 9061ms`, `WaitTime: 9067ms`, focus `null` (재진입 실패)
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 1차 launcher fallback + 2차 focus null로 fail
  - Evidence: `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/am_start_1_implicit.txt`, `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/focus_after_implicit_1.txt`, `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/focus_after_back_recents_home.txt`, `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/am_start_2_implicit.txt`, `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/focus_after_implicit_2.txt`, `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/after_implicit_2.png`, `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/logcat_tail.txt`, `artifacts/20260219_220021_adb_forcestop_implicit_back_recents_home_implicit_v2/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-02** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 7119ms`, `WaitTime: 7126ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 212ms`, `WaitTime: 239ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Recents→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/am_start_1_explicit.txt`, `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/focus_after_explicit.txt`, `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/focus_after_back_recents_home.txt`, `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/am_start_2_implicit.txt`, `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/focus_after_implicit.txt`, `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/after_implicit.png`, `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/logcat_tail.txt`, `artifacts/20260219_220233_adb_forcestop_explicit_back_recents_home_implicit_v2/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-EXPLICIT-03** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 13674ms`, `WaitTime: 13678ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 2157ms`, `WaitTime: 2161ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Recents→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/pid_after_forcestop.txt`, `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/am_start_1_implicit.txt`, `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/focus_after_implicit.txt`, `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/focus_after_back_recents_home.txt`, `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/am_start_2_explicit.txt`, `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/focus_after_explicit.txt`, `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/after_explicit.png`, `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/logcat_tail.txt`, `artifacts/20260219_220450_adb_forcestop_implicit_back_recents_home_explicit_v3/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-HOME-IMPLICIT-04** (AVD) force-stop 후 explicit 진입 뒤 Back→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 5346ms`, `WaitTime: 5368ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 376ms`, `WaitTime: 521ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/pid_after_forcestop.txt`, `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/am_start_1_explicit.txt`, `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/focus_after_explicit.txt`, `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/focus_after_back_home.txt`, `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/am_start_2_implicit.txt`, `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/focus_after_implicit.txt`, `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/after_implicit.png`, `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/logcat_tail.txt`, `artifacts/20260219_220658_adb_forcestop_explicit_back_home_implicit_v4/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-HOME-EXPLICIT-04** (AVD) force-stop 후 explicit 진입 뒤 Back→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 4698ms`, `WaitTime: 4734ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `TotalTime: 631ms`, `WaitTime: 655ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/pid_after_forcestop.txt`, `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/am_start_1_explicit.txt`, `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/focus_after_explicit_1.txt`, `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/focus_after_back_home.txt`, `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/am_start_2_explicit.txt`, `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/focus_after_explicit_2.txt`, `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/after_explicit_2.png`, `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/logcat_tail.txt`, `artifacts/20260219_220843_adb_forcestop_explicit_back_home_explicit_v4/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-EXPLICIT-04** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→explicit 재진입 재검증 — **failed (1차 implicit ANR dialog focus)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 22267ms`, `WaitTime: 22289ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `Activity: GraniteActivity`, `TotalTime: 24041ms`, `WaitTime: 24067ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 키워드 미검출(단, ANR dialog focus는 확인)
  - Verdict: 2차 explicit 복구는 되었으나 1차 implicit에서 ANR dialog 포커스로 fail
  - Evidence: `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/pid_after_forcestop.txt`, `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/am_start_1_implicit.txt`, `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/focus_after_implicit.txt`, `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/focus_after_back_home.txt`, `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/am_start_2_explicit.txt`, `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/focus_after_explicit.txt`, `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/after_explicit.png`, `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/logcat_tail.txt`, `artifacts/20260219_221059_adb_forcestop_implicit_back_home_explicit_v4/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-03** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 27394ms`, `WaitTime: 27410ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 561ms`, `WaitTime: 580ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Recents→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/pid_after_forcestop.txt`, `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/am_start_1_explicit.txt`, `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/focus_after_explicit.txt`, `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/focus_after_back_recents_home.txt`, `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/am_start_2_implicit.txt`, `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/focus_after_implicit.txt`, `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/after_implicit.png`, `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/logcat_tail.txt`, `artifacts/20260219_221342_adb_forcestop_explicit_back_recents_home_implicit_v3/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-EXPLICIT-03** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **failed (1차 explicit ANR dialog focus)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 28839ms`, `WaitTime: 28847ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 2448ms`, `WaitTime: 2465ms`, focus `GraniteActivity` (복구)
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 키워드 미검출(단, ANR dialog focus는 확인)
  - Verdict: 2차 explicit 복구는 되었으나 1차 explicit ANR dialog 포커스로 fail
  - Evidence: `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/pid_after_forcestop.txt`, `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/am_start_1_explicit.txt`, `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/focus_after_explicit_1.txt`, `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/focus_after_back_recents_home.txt`, `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/am_start_2_explicit.txt`, `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/focus_after_explicit_2.txt`, `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/after_explicit_2.png`, `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/logcat_tail.txt`, `artifacts/20260219_221621_adb_forcestop_explicit_back_recents_home_explicit_v3/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-IMPLICIT-04** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→implicit 재진입 재검증 — **failed (double launcher fallback + app ANR)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 20091ms`, focus `NexusLauncherActivity` (초기 진입 실패)
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 21348ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - logcat: `ANR in viva.republica.toss.test`, `Completed ANR` 검출
  - Verdict: 1차 launcher fallback + 2차 ANR dialog 포커스로 fail
  - Evidence: `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/pid_after_forcestop.txt`, `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/am_start_1_implicit.txt`, `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/focus_after_implicit_1.txt`, `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/focus_after_back_home.txt`, `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/am_start_2_implicit.txt`, `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/focus_after_implicit_2.txt`, `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/after_implicit_2.png`, `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/logcat_tail.txt`, `artifacts/20260219_221857_adb_forcestop_implicit_back_home_implicit_v4/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-HOME-IMPLICIT-05** (AVD) force-stop 후 explicit 진입 뒤 Back→Home→implicit 재진입 재검증 — **failed (1차 explicit ANR dialog focus)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 22601ms`, `WaitTime: 22658ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 17356ms`, `WaitTime: 17360ms`, focus `MiniAppSchemeActivity`
    - logcat에서 ANR/FATAL/obituary/"ANR likely to follow" 키워드 미검출(단, ANR dialog focus 확인)
  - Verdict: 2차 implicit 재진입은 되었지만 1차 explicit에서 ANR dialog 포커스로 fail
  - Evidence: `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/pid_after_forcestop.txt`, `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/am_start_1_explicit.txt`, `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/focus_after_explicit.txt`, `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/focus_after_back_home.txt`, `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/am_start_2_implicit.txt`, `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/focus_after_implicit.txt`, `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/after_implicit.png`, `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/logcat_tail.txt`, `artifacts/20260219_222129_adb_forcestop_explicit_back_home_implicit_v5/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-EXPLICIT-05** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→explicit 재진입 재검증 — **failed (1차 implicit ANR dialog focus)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 18687ms`, `WaitTime: 18711ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `Activity: GraniteActivity`, `TotalTime: 3542ms`, `WaitTime: 3545ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 키워드 미검출(단, ANR dialog focus 확인)
  - Verdict: 2차 explicit 복구는 되었으나 1차 implicit ANR dialog 포커스로 fail
  - Evidence: `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/pid_after_forcestop.txt`, `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/am_start_1_implicit.txt`, `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/focus_after_implicit.txt`, `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/focus_after_back_home.txt`, `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/am_start_2_explicit.txt`, `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/focus_after_explicit.txt`, `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/after_explicit.png`, `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/logcat_tail.txt`, `artifacts/20260219_222419_adb_forcestop_implicit_back_home_explicit_v5/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-HOME-IMPLICIT-06** (AVD) force-stop 후 explicit 진입 뒤 Back→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 19461ms`, `WaitTime: 19484ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 248ms`, `WaitTime: 324ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/pid_after_forcestop.txt`, `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/am_start_1_explicit.txt`, `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/focus_after_explicit.txt`, `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/focus_after_back_home.txt`, `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/am_start_2_implicit.txt`, `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/focus_after_implicit.txt`, `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/after_implicit.png`, `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/logcat_tail.txt`, `artifacts/20260219_222624_adb_forcestop_explicit_back_home_implicit_v6/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-HOME-EXPLICIT-05** (AVD) force-stop 후 explicit 진입 뒤 Back→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 22400ms`, `WaitTime: 22420ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `TotalTime: 1287ms`, `WaitTime: 1384ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/pid_after_forcestop.txt`, `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/am_start_1_explicit.txt`, `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/focus_after_explicit_1.txt`, `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/focus_after_back_home.txt`, `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/am_start_2_explicit.txt`, `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/focus_after_explicit_2.txt`, `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/after_explicit_2.png`, `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/logcat_tail.txt`, `artifacts/20260219_222916_adb_forcestop_explicit_back_home_explicit_v5/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-IMPLICIT-05** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: GraniteActivity`, `TotalTime: 21157ms`, `WaitTime: 21171ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 714ms`, `WaitTime: 1459ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/pid_after_forcestop.txt`, `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/am_start_1_implicit.txt`, `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/focus_after_implicit_1.txt`, `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/focus_after_back_home.txt`, `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/am_start_2_implicit.txt`, `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/focus_after_implicit_2.txt`, `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/after_implicit_2.png`, `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/logcat_tail.txt`, `artifacts/20260219_223248_adb_forcestop_implicit_back_home_implicit_v5/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-EXPLICIT-06** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 11529ms`, `WaitTime: 11536ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 595ms`, `WaitTime: 616ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/pid_after_forcestop.txt`, `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/am_start_1_implicit.txt`, `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/focus_after_implicit.txt`, `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/focus_after_back_home.txt`, `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/am_start_2_explicit.txt`, `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/focus_after_explicit.txt`, `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/after_explicit.png`, `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/logcat_tail.txt`, `artifacts/20260219_223449_adb_forcestop_implicit_back_home_explicit_v6/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-04** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (1차 explicit ANR + 2차 implicit launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 23368ms`, `WaitTime: 23390ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 10295ms`, focus `NexusLauncherActivity` (재진입 실패)
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 키워드 미검출(단, ANR dialog focus 확인)
  - Verdict: 1차 explicit ANR dialog 및 2차 implicit launcher fallback으로 fail
  - Evidence: `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/pid_after_forcestop.txt`, `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/am_start_1_explicit.txt`, `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/focus_after_explicit.txt`, `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/focus_after_back_recents_home.txt`, `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/am_start_2_implicit.txt`, `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/focus_after_implicit.txt`, `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/after_implicit.png`, `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/logcat_tail.txt`, `artifacts/20260219_223639_adb_forcestop_explicit_back_recents_home_implicit_v4/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-EXPLICIT-04** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **failed (double launcher fallback + app ANR)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: GraniteActivity`, `WaitTime: 18186ms`, focus `NexusLauncherActivity` (진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: GraniteActivity`, `WaitTime: 16300ms`, focus `NexusLauncherActivity` (재진입 실패)
    - logcat에서 `ANR in viva.republica.toss.test`, `Completed ANR` 검출
  - Verdict: 양쪽 explicit 모두 launcher fallback이며 ANR 동반으로 fail
  - Evidence: `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/pid_after_forcestop.txt`, `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/am_start_1_explicit.txt`, `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/focus_after_explicit_1.txt`, `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/focus_after_back_recents_home.txt`, `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/am_start_2_explicit.txt`, `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/focus_after_explicit_2.txt`, `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/after_explicit_2.png`, `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/logcat_tail.txt`, `artifacts/20260219_223848_adb_forcestop_explicit_back_recents_home_explicit_v4/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-06** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (1차 implicit start timeout)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: timeout`, `LaunchState: UNKNOWN (-1)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 23317ms` (타임아웃), focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 944ms`, `WaitTime: 955ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 2차 재진입은 정상이나 1차 implicit가 `Status: timeout`으로 fail
  - Evidence: `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/pid_after_forcestop.txt`, `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/am_start_1_implicit.txt`, `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/focus_after_implicit_1.txt`, `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/focus_after_back_recents_home.txt`, `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/am_start_2_implicit.txt`, `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/focus_after_implicit_2.txt`, `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/after_implicit_2.png`, `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/logcat_tail.txt`, `artifacts/20260219_224052_adb_forcestop_implicit_back_recents_home_implicit_v6/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-EXPLICIT-04** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 9439ms`, `WaitTime: 9445ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 812ms`, `WaitTime: 888ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Recents→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/pid_after_forcestop.txt`, `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/am_start_1_implicit.txt`, `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/focus_after_implicit.txt`, `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/focus_after_back_recents_home.txt`, `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/am_start_2_explicit.txt`, `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/focus_after_explicit.txt`, `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/after_explicit.png`, `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/logcat_tail.txt`, `artifacts/20260219_224251_adb_forcestop_implicit_back_recents_home_explicit_v4/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-05** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 2358ms`, `WaitTime: 2373ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 263ms`, `WaitTime: 313ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Recents→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/pid_after_forcestop.txt`, `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/am_start_1_explicit.txt`, `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/focus_after_explicit.txt`, `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/focus_after_back_recents_home.txt`, `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/am_start_2_implicit.txt`, `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/focus_after_implicit.txt`, `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/after_implicit.png`, `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/logcat_tail.txt`, `artifacts/20260219_224427_adb_forcestop_explicit_back_recents_home_implicit_v5/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-EXPLICIT-05** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **failed (1차 implicit launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 13066ms`, focus `NexusLauncherActivity` (진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `Activity: GraniteActivity`, `TotalTime: 4036ms`, `WaitTime: 4040ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 1차 implicit launcher fallback으로 fail (2차 explicit은 복구)
  - Evidence: `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/pid_after_forcestop.txt`, `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/am_start_1_implicit.txt`, `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/focus_after_implicit.txt`, `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/focus_after_back_recents_home.txt`, `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/am_start_2_explicit.txt`, `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/focus_after_explicit.txt`, `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/after_explicit.png`, `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/logcat_tail.txt`, `artifacts/20260219_224617_adb_forcestop_implicit_back_recents_home_explicit_v5/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-EXPLICIT-05** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **failed (1차 explicit launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: GraniteActivity`, `WaitTime: 15301ms`, focus `NexusLauncherActivity` (진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `Activity: GraniteActivity`, `TotalTime: 16818ms`, `WaitTime: 16821ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 1차 explicit launcher fallback으로 fail (2차 explicit은 복구)
  - Evidence: `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/pid_after_forcestop.txt`, `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/am_start_1_explicit.txt`, `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/focus_after_explicit_1.txt`, `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/focus_after_back_recents_home.txt`, `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/am_start_2_explicit.txt`, `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/focus_after_explicit_2.txt`, `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/after_explicit_2.png`, `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/logcat_tail.txt`, `artifacts/20260219_224803_adb_forcestop_explicit_back_recents_home_explicit_v5/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-07** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 11122ms`, `WaitTime: 11154ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 601ms`, `WaitTime: 632ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Recents→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/pid_after_forcestop.txt`, `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/am_start_1_implicit.txt`, `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/focus_after_implicit_1.txt`, `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/focus_after_back_recents_home.txt`, `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/am_start_2_implicit.txt`, `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/focus_after_implicit_2.txt`, `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/after_implicit_2.png`, `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/logcat_tail.txt`, `artifacts/20260219_225013_adb_forcestop_implicit_back_recents_home_implicit_v7/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-06** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (1차 explicit launcher fallback + 2차 implicit ANR)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: GraniteActivity`, `WaitTime: 16618ms`, focus `NexusLauncherActivity` (진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 17489ms`, `WaitTime: 17560ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - logcat에서 `ANR in viva.republica.toss.test`, `Completed ANR` 검출
  - Verdict: 1차 explicit launcher fallback 및 2차 implicit ANR로 fail
  - Evidence: `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/pid_after_forcestop.txt`, `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/am_start_1_explicit.txt`, `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/focus_after_explicit.txt`, `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/focus_after_back_recents_home.txt`, `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/am_start_2_implicit.txt`, `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/focus_after_implicit.txt`, `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/after_implicit.png`, `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/logcat_tail.txt`, `artifacts/20260219_225209_adb_forcestop_explicit_back_recents_home_implicit_v6/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-EXPLICIT-06** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **failed (1차 implicit launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 11651ms`, focus `NexusLauncherActivity` (진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `Activity: GraniteActivity`, `TotalTime: 14102ms`, `WaitTime: 14135ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 1차 implicit launcher fallback으로 fail (2차 explicit은 복구)
  - Evidence: `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/pid_after_forcestop.txt`, `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/am_start_1_implicit.txt`, `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/focus_after_implicit.txt`, `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/focus_after_back_recents_home.txt`, `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/am_start_2_explicit.txt`, `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/focus_after_explicit.txt`, `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/after_explicit.png`, `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/logcat_tail.txt`, `artifacts/20260219_225437_adb_forcestop_implicit_back_recents_home_explicit_v6/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-EXPLICIT-06** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 12725ms`, `WaitTime: 12741ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `TotalTime: 937ms`, `WaitTime: 1005ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Recents→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/pid_after_forcestop.txt`, `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/am_start_1_explicit.txt`, `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/focus_after_explicit_1.txt`, `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/focus_after_back_recents_home.txt`, `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/am_start_2_explicit.txt`, `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/focus_after_explicit_2.txt`, `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/after_explicit_2.png`, `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/logcat_tail.txt`, `artifacts/20260219_225634_adb_forcestop_explicit_back_recents_home_explicit_v6/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-08** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 5116ms`, `WaitTime: 5120ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 541ms`, `WaitTime: 579ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Recents→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/pid_after_forcestop.txt`, `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/am_start_1_implicit.txt`, `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/focus_after_implicit_1.txt`, `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/focus_after_back_recents_home.txt`, `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/am_start_2_implicit.txt`, `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/focus_after_implicit_2.txt`, `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/after_implicit_2.png`, `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/logcat_tail.txt`, `artifacts/20260219_225850_adb_forcestop_implicit_back_recents_home_implicit_v8/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-07** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 5623ms`, `WaitTime: 5640ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 414ms`, `WaitTime: 469ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Recents→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/pid_after_forcestop.txt`, `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/am_start_1_explicit.txt`, `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/focus_after_explicit.txt`, `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/focus_after_back_recents_home.txt`, `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/am_start_2_implicit.txt`, `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/focus_after_implicit.txt`, `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/after_implicit.png`, `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/logcat_tail.txt`, `artifacts/20260219_230032_adb_forcestop_explicit_back_recents_home_implicit_v7/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-09** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (1차 implicit ANR + 2차 launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 19266ms`, `WaitTime: 19286ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 10332ms`, focus `NexusLauncherActivity` (재진입 실패)
    - logcat 스캔에서 `obituary` 검출(ANR dialog focus 동반)
  - Verdict: 1차 implicit ANR dialog + 2차 implicit launcher fallback으로 fail
  - Evidence: `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/pid_after_forcestop.txt`, `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/am_start_1_implicit.txt`, `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/focus_after_implicit_1.txt`, `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/focus_after_back_recents_home.txt`, `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/am_start_2_implicit.txt`, `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/focus_after_implicit_2.txt`, `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/after_implicit_2.png`, `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/logcat_tail.txt`, `artifacts/20260219_230212_adb_forcestop_implicit_back_recents_home_implicit_v9/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-EXPLICIT-07** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **failed (double launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: GraniteActivity`, `WaitTime: 11661ms`, focus `NexusLauncherActivity` (진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: GraniteActivity`, `WaitTime: 15972ms`, focus `NexusLauncherActivity` (재진입 실패)
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 양쪽 explicit 모두 launcher fallback으로 fail
  - Evidence: `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/pid_after_forcestop.txt`, `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/am_start_1_explicit.txt`, `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/focus_after_explicit_1.txt`, `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/focus_after_back_recents_home.txt`, `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/am_start_2_explicit.txt`, `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/focus_after_explicit_2.txt`, `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/after_explicit_2.png`, `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/logcat_tail.txt`, `artifacts/20260219_230425_adb_forcestop_explicit_back_recents_home_explicit_v7/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-EXPLICIT-07** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 16806ms`, `WaitTime: 16852ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 786ms`, `WaitTime: 806ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Recents→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/pid_after_forcestop.txt`, `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/am_start_1_implicit.txt`, `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/focus_after_implicit.txt`, `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/focus_after_back_recents_home.txt`, `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/am_start_2_explicit.txt`, `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/focus_after_explicit.txt`, `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/after_explicit.png`, `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/logcat_tail.txt`, `artifacts/20260219_230633_adb_forcestop_implicit_back_recents_home_explicit_v7/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-10** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (1차 launcher fallback + 2차 ANR)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 16206ms`, focus `NexusLauncherActivity` (진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 24170ms`, `WaitTime: 24221ms`, 직후 focus `Application Not Responding: viva.republica.toss.test`
    - logcat에서 `ANR in viva.republica.toss.test`, `Completed ANR` 검출
  - Verdict: 1차 implicit launcher fallback 및 2차 implicit ANR로 fail
  - Evidence: `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/pid_after_forcestop.txt`, `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/am_start_1_implicit.txt`, `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/focus_after_implicit_1.txt`, `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/focus_after_back_recents_home.txt`, `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/am_start_2_implicit.txt`, `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/focus_after_implicit_2.txt`, `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/after_implicit_2.png`, `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/logcat_tail.txt`, `artifacts/20260219_230825_adb_forcestop_implicit_back_recents_home_implicit_v10/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-08** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (2차 implicit focus null)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 12066ms`, `WaitTime: 12080ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 240ms`, `WaitTime: 303ms`, focus `null`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 2차 implicit에서 `mCurrentFocus=null` 확인되어 fail
  - Evidence: `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/pid_after_forcestop.txt`, `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/am_start_1_explicit.txt`, `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/focus_after_explicit.txt`, `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/focus_after_back_recents_home.txt`, `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/am_start_2_implicit.txt`, `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/focus_after_implicit.txt`, `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/after_implicit.png`, `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/logcat_tail.txt`, `artifacts/20260219_231103_adb_forcestop_explicit_back_recents_home_implicit_v8/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-EXPLICIT-08** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 2275ms`, `WaitTime: 2345ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 1121ms`, `WaitTime: 1126ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Recents→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/pid_after_forcestop.txt`, `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/am_start_1_implicit.txt`, `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/focus_after_implicit.txt`, `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/focus_after_back_recents_home.txt`, `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/am_start_2_explicit.txt`, `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/focus_after_explicit.txt`, `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/after_explicit.png`, `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/logcat_tail.txt`, `artifacts/20260219_231245_adb_forcestop_implicit_back_recents_home_explicit_v8/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-09** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 5053ms`, `WaitTime: 5059ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 639ms`, `WaitTime: 734ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Recents→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/pid_after_forcestop.txt`, `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/am_start_1_explicit.txt`, `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/focus_after_explicit.txt`, `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/focus_after_back_recents_home.txt`, `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/am_start_2_implicit.txt`, `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/focus_after_implicit.txt`, `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/after_implicit.png`, `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/logcat_tail.txt`, `artifacts/20260219_231440_adb_forcestop_explicit_back_recents_home_implicit_v9/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-11** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (2차 implicit focus null)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 7470ms`, `WaitTime: 7482ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 442ms`, `WaitTime: 463ms`, focus `null`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 2차 implicit에서 `mCurrentFocus=null` 확인되어 fail
  - Evidence: `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/pid_after_forcestop.txt`, `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/am_start_1_implicit.txt`, `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/focus_after_implicit_1.txt`, `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/focus_after_back_recents_home.txt`, `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/am_start_2_implicit.txt`, `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/focus_after_implicit_2.txt`, `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/after_implicit_2.png`, `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/logcat_tail.txt`, `artifacts/20260219_231645_adb_forcestop_implicit_back_recents_home_implicit_v11/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-EXPLICIT-08** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 8273ms`, `WaitTime: 8344ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `TotalTime: 648ms`, `WaitTime: 662ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Recents→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/pid_after_forcestop.txt`, `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/am_start_1_explicit.txt`, `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/focus_after_explicit_1.txt`, `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/focus_after_back_recents_home.txt`, `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/am_start_2_explicit.txt`, `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/focus_after_explicit_2.txt`, `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/after_explicit_2.png`, `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/logcat_tail.txt`, `artifacts/20260219_231858_adb_forcestop_explicit_back_recents_home_explicit_v8/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-RECENTS-HOME-IMPLICIT-12** (AVD) force-stop 후 implicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **failed (double launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 13905ms`, focus `NexusLauncherActivity` (진입 실패)
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 15975ms`, focus `NexusLauncherActivity` (재진입 실패)
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 양쪽 implicit 모두 launcher fallback으로 fail
  - Evidence: `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/pid_after_forcestop.txt`, `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/am_start_1_implicit.txt`, `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/focus_after_implicit_1.txt`, `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/focus_after_back_recents_home.txt`, `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/am_start_2_implicit.txt`, `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/focus_after_implicit_2.txt`, `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/after_implicit_2.png`, `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/logcat_tail.txt`, `artifacts/20260219_232046_adb_forcestop_implicit_back_recents_home_implicit_v12/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-RECENTS-HOME-IMPLICIT-10** (AVD) force-stop 후 explicit 진입 뒤 Back→Recents→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `APP_SWITCH` → `HOME` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 26717ms`, `WaitTime: 26722ms`, focus `GraniteActivity`
    - Back→Recents→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 493ms`, `WaitTime: 575ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Recents→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/pid_after_forcestop.txt`, `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/am_start_1_explicit.txt`, `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/focus_after_explicit.txt`, `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/focus_after_back_recents_home.txt`, `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/am_start_2_implicit.txt`, `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/focus_after_implicit.txt`, `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/after_implicit.png`, `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/logcat_tail.txt`, `artifacts/20260219_232315_adb_forcestop_explicit_back_recents_home_implicit_v10/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-EXPLICIT-07** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 2763ms`, `WaitTime: 2783ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 1930ms`, `WaitTime: 1941ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/pid_after_forcestop.txt`, `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/am_start_1_implicit.txt`, `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/focus_after_implicit.txt`, `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/focus_after_back_home.txt`, `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/am_start_2_explicit.txt`, `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/focus_after_explicit.txt`, `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/after_explicit.png`, `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/logcat_tail.txt`, `artifacts/20260220_032524_adb_forcestop_implicit_back_home_explicit_v7/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-IMPLICIT-13** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 1804ms`, `WaitTime: 1821ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 286ms`, `WaitTime: 367ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/pid_after_forcestop.txt`, `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/am_start_1_implicit.txt`, `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/focus_after_implicit_1.txt`, `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/focus_after_back_home.txt`, `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/am_start_2_implicit.txt`, `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/focus_after_implicit_2.txt`, `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/after_implicit_2.png`, `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/logcat_tail.txt`, `artifacts/20260220_032752_adb_forcestop_implicit_back_home_implicit_v13/log_hits.txt`

- Notes:
  - Login: Toss login button is one-tap (auto login).
  - App capability: file upload only (no text message send).

- Last update: 2026-02-20 03:29 KST
