...
- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-EXPLICIT-03** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 19085ms`, `WaitTime: 19096ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `Activity: GraniteActivity`, `TotalTime: 634ms`, `WaitTime: 662ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/pid_after_forcestop.txt`, `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/am_start_1_implicit.txt`, `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/focus_after_implicit.txt`, `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/focus_after_back_home.txt`, `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/am_start_2_explicit.txt`, `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/focus_after_explicit.txt`, `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/after_explicit.png`, `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/logcat_tail.txt`, `artifacts/20260219_212506_adb_forcestop_implicit_back_home_explicit_v3/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-BACK-HOME-EXPLICIT-03** (AVD) force-stop 후 explicit 진입 뒤 Back→Home→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `BACK` → `HOME` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 3880ms`, `WaitTime: 3895ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: WARM`, `TotalTime: 686ms`, `WaitTime: 747ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Back→Home 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/pid_after_forcestop.txt`, `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/am_start_1_explicit.txt`, `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/focus_after_explicit_1.txt`, `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/focus_after_back_home.txt`, `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/am_start_2_explicit.txt`, `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/focus_after_explicit_2.txt`, `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/after_explicit_2.png`, `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/logcat_tail.txt`, `artifacts/20260219_212702_adb_forcestop_explicit_back_home_explicit_v3/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-BACK-HOME-IMPLICIT-03** (AVD) force-stop 후 implicit 진입 뒤 Back→Home→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `BACK` → `HOME` → implicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: COLD`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 18986ms`, `WaitTime: 19014ms`, focus `GraniteActivity`
    - Back→Home 후 focus: `NexusLauncherActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 1195ms`, `WaitTime: 1210ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 implicit 진입 및 Back→Home 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/pid_after_forcestop.txt`, `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/am_start_1_implicit.txt`, `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/focus_after_implicit_1.txt`, `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/focus_after_back_home.txt`, `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/am_start_2_implicit.txt`, `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/focus_after_implicit_2.txt`, `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/after_implicit_2.png`, `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/logcat_tail.txt`, `artifacts/20260219_212836_adb_forcestop_implicit_back_home_implicit_v3/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-RECENTS-BACK-IMPLICIT-02** (AVD) force-stop 후 explicit 진입 뒤 Recents→Back→implicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `APP_SWITCH` → `BACK` → implicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 10604ms`, `WaitTime: 10622ms`, focus `GraniteActivity`
    - Recents→Back 후 focus: `GraniteActivity`
    - 2차 implicit: `Status: ok`, `LaunchState: WARM`, `Activity: .MiniAppSchemeActivity`, `TotalTime: 339ms`, `WaitTime: 349ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Recents→Back 경유 implicit 재진입 정상
  - Evidence: `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/am_start_1_explicit.txt`, `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/focus_after_explicit.txt`, `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/focus_after_recents_back.txt`, `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/am_start_2_implicit.txt`, `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/focus_after_implicit.txt`, `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/after_implicit.png`, `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/logcat_tail.txt`, `artifacts/20260219_213108_adb_forcestop_explicit_recents_back_implicit_v2/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-IMPLICIT-RECENTS-BACK-EXPLICIT-02** (AVD) force-stop 후 implicit 진입 뒤 Recents→Back→explicit 재진입 재검증 — **failed (initial launcher fallback)**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → implicit deeplink 실행 → `APP_SWITCH` → `BACK` → explicit deeplink 실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 implicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Activity: .MiniAppSchemeActivity`, `WaitTime: 11369ms`, focus `NexusLauncherActivity` (초기 진입 실패)
    - Recents→Back 후 focus: `NexusLauncherActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 5339ms`, `WaitTime: 5351ms`, focus `GraniteActivity` (복구)
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: 2차 explicit 복구는 성공했지만 1차 implicit launcher fallback으로 fail
  - Evidence: `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/am_start_1_implicit.txt`, `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/focus_after_implicit.txt`, `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/focus_after_recents_back.txt`, `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/am_start_2_explicit.txt`, `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/focus_after_explicit.txt`, `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/after_explicit.png`, `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/logcat_tail.txt`, `artifacts/20260219_213310_adb_forcestop_implicit_recents_back_explicit_v2/log_hits.txt`

- [x] **TC-ADB-FORCESTOP-EXPLICIT-RECENTS-BACK-EXPLICIT-02** (AVD) force-stop 후 explicit 진입 뒤 Recents→Back→explicit 재진입 재검증 — **passed**
  - Steps: `HOME` → `am force-stop viva.republica.toss.test` → explicit deeplink 실행 → `APP_SWITCH` → `BACK` → explicit deeplink 재실행
  - Observed:
    - force-stop 직후 pid 조회: 프로세스 미존재(정상 종료)
    - 1차 explicit: `Status: ok`, `LaunchState: COLD`, `TotalTime: 7509ms`, `WaitTime: 7530ms`, focus `GraniteActivity`
    - Recents→Back 후 focus: `GraniteActivity`
    - 2차 explicit: `Status: ok`, `LaunchState: UNKNOWN (0)`, `Warning: intent delivered to currently running top-most instance`, `WaitTime: 18ms`, focus `GraniteActivity`
    - logcat 스캔에서 ANR/FATAL/obituary/"ANR likely to follow" 미검출
  - Verdict: force-stop 이후 explicit 진입 및 Recents→Back 경유 explicit 재진입 정상
  - Evidence: `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/pid_after_forcestop.txt`, `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/am_start_1_explicit.txt`, `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/focus_after_explicit_1.txt`, `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/focus_after_recents_back.txt`, `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/am_start_2_explicit.txt`, `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/focus_after_explicit_2.txt`, `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/after_explicit_2.png`, `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/logcat_tail.txt`, `artifacts/20260219_213535_adb_forcestop_explicit_recents_back_explicit_v2/log_hits.txt`

- Notes:
  - Login: Toss login button is one-tap (auto login).
  - App capability: file upload only (no text message send).

- Last update: 2026-02-19 21:38 KST
